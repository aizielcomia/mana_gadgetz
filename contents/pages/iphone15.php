...
<body>
    ...
    <main class="menu-con">
        <?php
            ...
            $sql = "SELECT * FROM products WHERE category = 'iphone15' ORDER BY id DESC";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '</div>';
                    echo '<form class="add-to-cart-form" action="contents/logic/add_to_cart.php" method="POST">';
                ...
                echo '<p class="no-items">No iPhone 15 found.</p>';
            }
